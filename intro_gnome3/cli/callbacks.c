...
// Function used to send an UDP message with 'entryText' contents to the address in 'entryIP'
void send_message_ipv4 ( const gchar * ip )
{
	...
	// This event is synchronized with the GTK thread - it was called by GTK
